...
fun getPoints(original: Mat): List<Point> {
	...
	val squares = kotlin.collections.ArrayList<MatOfPoint>()
	val threshSquares: ArrayList<MatOfPoint> = kotlin.collections.ArrayList()
	val cannySquares = SparseArray<MatOfPoint>()
	val indices = kotlin.collections.ArrayList<Int>()
...
//                }
	...
	val squaresProba: ArrayList<MatOfPoint> = kotlin.collections.ArrayList()
	...
	if (squaresProba.isNotEmpty()) {
		...
		if (squaresProba.isNotEmpty()) {
			...
			val pts: MutableList<Point> = kotlin.collections.ArrayList()
...
private fun findCannySquares(
	...
	// contours search
	val contours: List<MatOfPoint> = kotlin.collections.ArrayList()
